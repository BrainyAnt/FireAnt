...
def forward(value):
    swift.set_position(1, 0, 0, speed=50000, relative=True, wait=True)
def back(value):
    swift.set_position(-1, 0, 0, speed=50000, relative=True, wait=True)
def left(value):
    swift.set_position(0, 1, 0, speed=50000, relative=True, wait=True)
def right(value):
    swift.set_position(0, -1, 0, speed=50000, relative=True, wait=True)
def up(value):
    swift.set_position(0, 0, 1, speed=50000, relative=True, wait=True)
def down(value):
    swift.set_position(0, 0, -1, speed=50000, relative=True, wait=True)

def stretch(scoord):
    swift.set_polar(1, 0, 0, speed=50000, relative=True, wait=True)
def retract(scoord):
    swift.set_polar(-1, 0, 0, speed=50000, relative=True, wait=True)
def rotate_left(rcoord):
    swift.set_polar(0, 1, 0, speed=50000, relative=True, wait=True)
def rotate_right(rcoord):
    swift.set_polar(0, -1, 0, speed=50000, relative=True, wait=True)
def upward(hcoord):
    swift.set_polar(0, 0, 1, speed=50000, relative=True, wait=True)
def downward(hcoord):
    swift.set_polar(0, 0, -1, speed=50000, relative=True, wait=True)
